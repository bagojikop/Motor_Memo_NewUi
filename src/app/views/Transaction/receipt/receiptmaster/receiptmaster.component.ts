...
export class ReceiptmasterComponent {
  ...
  addNew() {
    ...
    this.router.navigate(['Receiptchild'], { state: params });
  }
  ...
  edit(s) {
    ...
    this.router.navigate(['Receiptchild'], { state: param });
  ...
  iConfirmFn(row) {
    ...
    this.http.delete('receipt/delete', params).subscribe((res: any) => {
      if (res.status_cd == 1) {
